...
import ReligiImage from '../../assets/img/ReligiImage.png'
...
const PerjalananReligiPage = (props) => {
  ...
  return (
    <div>
      <LayoutProduct title="Moxa PERJALANAN RELIGI"  descriptions="Pembiayaan Perjalanan religi">
        <div id="homepage">
          <PSection1  titleBanner="PERJALANAN RELIGI" subtitleBanner="Pembiayaan mobil, mencari pinjaman, 
asuransi, dan masih banyak lagi, 
semuanya dalam satu aplikasi" image={ReligiImage}/>
          <PSection23 />
          <PSection32 />
          <PSection4 />
...
export default PerjalananReligiPage;
