        ...
        <div className="wrapper">
          ...
          <div className="row" style={{marginTop:'50px',marginBottom:'50px'}}>
            <div className="col" style={{margin:'auto'}}>
                ...
                <h3 style={{color:'#04325F',fontWeight:'700',fontSize:'25px'}}>Pinjaman Tanpa Jaminan</h3>
...
dolor sit amet, dolor sit amet, chohci  </p>
            ...
            <div className="col" style={{margin:'auto'}}>
                <img src={iconMotor}/><br/>
                <h3 style={{color:'#04325F',fontWeight:'700',fontSize:'25px'}}>Pinjaman Dengan Jaminan</h3>
                <p style={{fontWeight:'500',fontSize:'20px'}}>Lorem ipsum dolor sit amet,
dolor sit amet, dolor sit amet, 
dolor sit amet, dolor sit amet, chohci </p>
            </div>
